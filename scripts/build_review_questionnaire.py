  ...
  <div class="hero-inner">
    <div class="brandbar">
      ...
      <div class="brand-meta">
        <!-- Reviewers are human participants: the instrument carries a role, never
             a name, so no generated artifact can identify anyone. -->
        <span class="bm-label">Blinded reviewer</span>
        <span class="bm-name">Participant ID: __PARTICIPANT_ID__</span>
      </div>
    </div>
